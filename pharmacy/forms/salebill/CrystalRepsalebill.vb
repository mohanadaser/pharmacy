...
Public Class CrystalRepsalebill
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pharmacy.CrystalRepsalebill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalRepsalebill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalRepsalebill = New CrystalRepsalebill()
        rpt.Site = Me.Site
        Return rpt
    End Function
