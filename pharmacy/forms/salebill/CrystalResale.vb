...
Public Class CrystalResale
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pharmacy.CrystalResale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalResale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalResale = New CrystalResale()
        rpt.Site = Me.Site
        Return rpt
    End Function
