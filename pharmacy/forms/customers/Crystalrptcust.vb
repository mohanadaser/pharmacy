...
Public Class Crystalrptcust
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pharmacy.Crystalrptcust.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalrptcust
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystalrptcust = New Crystalrptcust()
        rpt.Site = Me.Site
        Return rpt
    End Function
