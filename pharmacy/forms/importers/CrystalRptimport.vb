...
Public Class CrystalRptimport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pharmacy.CrystalRptimport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalRptimport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalRptimport = New CrystalRptimport()
        rpt.Site = Me.Site
        Return rpt
    End Function
