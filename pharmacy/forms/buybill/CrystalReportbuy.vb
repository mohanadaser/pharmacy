...
Public Class CrystalReportbuy
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pharmacy.CrystalReportbuy.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportbuy
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportbuy = New CrystalReportbuy()
        rpt.Site = Me.Site
        Return rpt
    End Function
