...
Public Class CrystalReportrebuy
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pharmacy.CrystalReportrebuy.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportrebuy
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportrebuy = New CrystalReportrebuy()
        rpt.Site = Me.Site
        Return rpt
    End Function
