...
Partial Public Class pharmacyDataSet
    ...
    Partial Public Class itemsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AdditemsRow(ByVal id_item As Integer, ByVal item_name As String, ByVal category As String, ByVal item_unit As String, ByVal qty As Integer, ByVal company As String, ByVal sale_price As Decimal, ByVal buy_price As Decimal, ByVal expire_date As String, ByVal limit_item As Integer, ByVal barcode_item As String) As itemsRow
            Dim rowitemsRow As itemsRow = CType(Me.NewRow,itemsRow)
            Dim columnValuesArray() As Object = New Object() {id_item, item_name, category, item_unit, qty, company, sale_price, buy_price, expire_date, limit_item, barcode_item}
    ...
    Partial Public Class itemsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `items` WHERE ((`id_item` = ?) AND ((? = 1 AND `item_name` IS NULL) O"& _ 
                ...
                "ND ((? = 1 AND `sale_price` IS NULL) OR (`sale_price` = ?)) AND ((? = 1 AND `buy"& _ 
                "_price` IS NULL) OR (`buy_price` = ?)) AND ((? = 1 AND `expire_date` IS NULL) OR"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `items` (`id_item`, `item_name`, `category`, `item_unit`, `qty`, `com"& _ 
                "pany`, `sale_price`, `buy_price`, `expire_date`, `limit_item`, `barcode_item`) V"& _ 
                "ALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `items` SET `id_item` = ?, `item_name` = ?, `category` = ?, `item_unit` = "& _ 
                "?, `qty` = ?, `company` = ?, `sale_price` = ?, `buy_price` = ?, `expire_date` = "& _ 
                ...
                "OR (`company` = ?)) AND ((? = 1 AND `sale_price` IS NULL) OR (`sale_price` = ?))"& _ 
                " AND ((? = 1 AND `buy_price` IS NULL) OR (`buy_price` = ?)) AND ((? = 1 AND `exp"& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT id_item, item_name, category, item_unit, qty, company, sale_price, buy_pri"& _ 
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As pharmacyDataSet.itemsDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As pharmacyDataSet.itemsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As pharmacyDataSet.itemsDataTable = New pharmacyDataSet.itemsDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As pharmacyDataSet.itemsDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_id_item As Global.System.Nullable(Of Integer), ByVal Original_item_name As String, ByVal Original_category As String, ByVal Original_item_unit As String, ByVal Original_qty As Global.System.Nullable(Of Integer), ByVal Original_company As String, ByVal Original_sale_price As Global.System.Nullable(Of Decimal), ByVal Original_buy_price As Global.System.Nullable(Of Decimal), ByVal Original_expire_date As String, ByVal Original_limit_item As Global.System.Nullable(Of Integer), ByVal Original_barcode_item As String) As Integer
            ...
            If (Original_sale_price.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(12).Value = CType(Original_sale_price.Value,Decimal)
            Else
            ...
            If (Original_buy_price.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(14).Value = CType(Original_buy_price.Value,Decimal)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal id_item As Global.System.Nullable(Of Integer), ByVal item_name As String, ByVal category As String, ByVal item_unit As String, ByVal qty As Global.System.Nullable(Of Integer), ByVal company As String, ByVal sale_price As Global.System.Nullable(Of Decimal), ByVal buy_price As Global.System.Nullable(Of Decimal), ByVal expire_date As String, ByVal limit_item As Global.System.Nullable(Of Integer), ByVal barcode_item As String) As Integer
            ...
            If (buy_price.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(7).Value = CType(buy_price.Value,Decimal)
            Else
        ...
        Public Overloads Overridable Function Update( _
            ...
            End If
            If (buy_price.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(buy_price.Value,Decimal)
            Else
            ...
            If (Original_sale_price.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(23).Value = CType(Original_sale_price.Value,Decimal)
            Else
            ...
            If (Original_buy_price.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(25).Value = CType(Original_buy_price.Value,Decimal)
            Else
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_limit_item As Global.System.Nullable(Of Integer),  _
                    ByVal Original_barcode_item As String) As Integer
            Return Me.Update(Original_id_item, item_name, category, item_unit, qty, company, sale_price, buy_price, expire_date, limit_item, barcode_item, Original_id_item, Original_item_name, Original_category, Original_item_unit, Original_qty, Original_company, Original_sale_price, Original_buy_price, Original_expire_date, Original_limit_item, Original_barcode_item)
        End Function
    End Class
